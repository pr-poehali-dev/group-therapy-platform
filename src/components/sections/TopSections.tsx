...
const OUR_POINTS = [
  ...
  "Встречи + общение в чате между встречами",
...
export function WhyChatSection() {
  return (
    <section className="py-20 lg:py-24 overflow-hidden" style={{ backgroundColor: "var(--cream)" }}>
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div>
            <FadeUp>
              <h2 className="font-display text-4xl lg:text-5xl font-light leading-tight mb-2" style={{ color: "var(--text-main)" }}>
                Зачем нужен<br />
                <em className="not-italic" style={{ color: "var(--olive)" }}>чат с психологом?</em>
              </h2>
            </FadeUp>
            <FadeUp delay={80}>
              <div className="w-16 h-1 rounded-full my-6" style={{ backgroundColor: "var(--olive)" }} />
            </FadeUp>
            <FadeUp delay={120}>
              <div className="space-y-5 font-body text-base leading-relaxed mb-8" style={{ color: "var(--text-muted)" }}>
                <p>Самое важное часто происходит между сессиями.</p>
                <p>
                  Вы можете поссориться с близким, что-то резко почувствовать или поймать себя на мысли: «Вот это мне точно нужно обсудить».
                </p>
                <p>Но до встречи ещё несколько дней — эмоции проходят, детали забываются.</p>
                <p>Поэтому психолог остаётся с вами в чате. Можно написать ему прямо в тот момент, когда что-то произошло, а он ответит в течение суток.</p>
              </div>
            </FadeUp>
            <FadeUp delay={160}>
              <div className="inline-flex items-center gap-3 rounded-2xl px-5 py-3" style={{ backgroundColor: "var(--beige)" }}>
                <div
                  className="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0"
                  style={{ backgroundColor: "var(--olive)" }}
                >
                  <Icon name="Clock" size={17} style={{ color: "var(--cream)" }} />
                </div>
                <span className="font-body font-medium text-base" style={{ color: "var(--text-main)" }}>
          ...
          <FadeUp delay={150}>
            ...
            >
              <div
                ...
                style={{
                  backgroundImage:
                    "radial-gradient(circle at 20% 15%, var(--blue-light) 0%, transparent 45%), radial-gradient(circle at 85% 85%, var(--lavender-light) 0%, transparent 45%)",
                }}
              />
              <div className="relative rounded-2xl overflow-hidden" style={{ aspectRatio: "4/3" }}>
                <img src={PHOTOS.chatBg} alt="Клиентка переписывается с психологом в чате" className="w-full h-full object-cover" />
                <div className="absolute inset-0" style={{ background: "linear-gradient(to top, rgba(46,40,32,0.15) 0%, transparent 50%)" }} />
              </div>
              <div
                className="absolute top-6 left-6 sm:top-10 sm:left-8 w-[78%] sm:w-[68%] rounded-2xl p-4 sm:p-5 shadow-lg"
                ...
                <div className="flex items-center gap-3 mb-4 pb-3 border-b" style={{ borderColor: "var(--border)" }}>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="font-body text-xs" style={{ color: "var(--text-muted)" }}>На связи</span>
                    </div>
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="rounded-xl rounded-tl-sm px-3 py-2 max-w-[85%]" style={{ backgroundColor: "var(--beige)" }}>
                    <p className="font-body text-xs sm:text-sm" style={{ color: "var(--text-main)" }}>
                      Спасибо, что поделились. Я вас слышу.
                    </p>
                  </div>
                  <div className="rounded-xl rounded-tr-sm px-3 py-2 max-w-[85%] ml-auto" style={{ backgroundColor: "var(--olive)" }}>
                    <p className="font-body text-xs sm:text-sm" style={{ color: "var(--cream)" }}>
                      Мне было очень тяжело сегодня…
                    </p>
                  </div>
                  <div className="rounded-xl rounded-tl-sm px-3 py-2 max-w-[85%]" style={{ backgroundColor: "var(--beige)" }}>
                    <p className="font-body text-xs sm:text-sm" style={{ color: "var(--text-main)" }}>
                      Давайте разберёмся вместе. Что сейчас для вас самое важное?
                    </p>
                  </div>
                </div>
              </div>
