...
const STEPS = [
  ...
  { num: "02", title: "Бережно уточним запрос", text: "Спросим, что вас беспокоит, какой формат удобен и готовы ли вы говорить в группе" },
  { num: "03", title: "Подберём подходящую группу", text: "Подберем людей с похожей темой, комфортный состав и психолога." },
  { num: "04", title: "Вы приходите на первую встречу", text: "Можно говорить, а можно сначала просто слушать. Если группа не подойдет — предложим другой вариант." },
];
