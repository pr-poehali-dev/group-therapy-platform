        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <FadeUp delay={200}>
                <p className="font-body text-base leading-relaxed mb-8" style={{ color: "var(--text-muted)" }}>Групповая терапия — это встречи с психологом и 5–8 людьми, которые проживают похожие трудности. Психолог следит за безопасностью, структурой встречи и помогает группе двигаться бережно. Через опыт других участников вы сможете лучше понять себя, получить поддержку и найти новые способы справляться со своим запросом. На первой встрече не обязательно говорить о личном — можно просто слушать.</p>
              </FadeUp>
        ...
        const psychologists = [
          {
            ...
            topics: "проблемами с самооценкой и отношениями",
